  ...
  return (
    <div className="p-5 rounded-xl bg-white/5 border border-white/10">
      ...
      <div className="flex justify-between mb-3">
        ...
        <span className="text-xs text-orange-400 bg-orange-400/10 px-3 py-1 rounded-full">
          Processing
        </span>
      </div>
...
const AvailableCard = ({
  ...
  return (
    <div className="p-5 rounded-xl bg-white/5 border border-white/10">
      ...
      <p className="text-sm text-gray-400">Doctor: {doctor}</p>
      ...
      <button className="mt-4 w-full py-2 rounded-lg bg-[#1C3A52] text-teal-400 font-medium hover:bg-[#24485f] transition">
        View Summary
      </button>
